(module
  ...
  (func $main (export "main")
    (call $assert_eq_i64 (i64.const 5)
      (call $calc (i64.const 3) (i64.const 2) (i32.const 0))
    )
    (call $assert_eq_i64 (i64.const 1)
      (call $calc (i64.const 3) (i64.const 2) (i32.const 1))
    )
    (call $assert_eq_i64 (i64.const 6)
      (call $calc (i64.const 3) (i64.const 2) (i32.const 2))
    )
  )
